...
import Carousel from '../_snowpack/pkg/react-bootstrap/Carousel.js';
...
import Row from '../_snowpack/pkg/react-bootstrap/Row.js'; // @ts-ignore

import GifPlayer from '../_snowpack/pkg/react-gif-player.js';
import { BrowserRouter as Router, Route, Switch } from '../_snowpack/pkg/react-router-dom.js'; // @ts-ignore

import Img from '../_snowpack/pkg/react-webp-image.js'; // import Form from './form';
...
const TopBottom = props => {
  ...
  }, "robosot-nav"), ") because I love the simplicity and efficiency of Python."))))), props.children) // <div>
  //   <nav id="navbar" className="navbar navbar-dark bg-dark">
  //     <a
  //       className="navbar-brand text-black"
  //       href="https://hackerton.github.io/"
  //     >
  //       Hackerton's Digital
  //     </a>
  //     <ul className="nav">
  ...
  //       </li>
  //       <li className="nav-item">
  //         <a className="nav-link" href="#two">
  //           Activites
  //         </a>
  //       </li>
  //       <li className="nav-item">
  //         <a className="nav-link" href="#three">
  //           Achievement
  //         </a>
  //       </li>
  //     </ul>
